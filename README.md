...
weather for all 14 regions of Uzbekistan.
...
- Interactive map, regional rankings, curated environmental news, and
  dedicated storm, wildfire and hurricane tracking, plus a community
  tree-planting tracker (Yashil Makon)
- CSRF-protected forms, gzip response compression, cached static assets
...
admin.py               Internal administration routes
